...
export function LightsDetails({onClose}: LightsDetailsProps): React.ReactElement | null {
    return <div className={[styles.item, styles["lights-details"]].join(" ")}>
