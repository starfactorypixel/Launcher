...
RightBeltIcon.displayName = "RightBeltIcon";

export interface RightBeltStore {
    belt: boolean;
    loaded: boolean;
}

export const RightBelt: React.FC = observer(() => {
    const store = useLocalObservable<RightBeltStore>(() => ({
        belt: false,
        loaded: false
    }));
    ...
    return <Item icon={<RightBeltIcon />} name="Right belt" active={belt} onClick={toggleBelt} />;
});

RightBelt.displayName = "RightBelt";
