...
export function NotInstalled(): React.ReactElement {
    return (
        <Page className={styles["navigator-not-installed"]}>
            <Section className={styles.section} container containerClassName={styles.container}>
                <Title variant={1}>Navigator app not selected</Title>
                <Paragraph className={styles.paragraph}>
                    Choose a default navigator application
                </Paragraph>
